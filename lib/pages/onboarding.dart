...
class OnboardingItem {
  ...
  OnboardingItem({
    ...
    this.titleTop,
    this.titleLeft,
  }) : assert(svgPath != null || imagePath != null, 'Either svgPath or imagePath must be provided');
}
        ...
        child: Stack(
          children: [
            ...
            Positioned(
              ...
              left: size.width * (item.titleLeft != null ? item.titleLeft! / size.width : 0.05),
            ...
            Positioned(
              ...
              left: item.imageLeft != null ? size.width * (item.imageLeft! / size.width) : 0,
              child: SizedBox(
                  ...
                  child: Align(
                    ...
                    child: item.svgPath != null
                        ? SvgPicture.asset(
                            item.svgPath!,
                            fit: BoxFit.contain,
                            placeholderBuilder: (context) => _buildLoadingPlaceholder(size),
